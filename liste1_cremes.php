...
// Requête pour récupérer les articles de la catégorie "Crèmes"
$sql = "
...
$articles_cremes = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
echo $twig->render('liste1_cremes.twig', [
    'articles_cremes' => $articles_cremes,
    'marques' => $marques,

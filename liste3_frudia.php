...
// Requête de base pour récupérer les articles de la marque "Frudia"
$sql = "
...
$articles_frudia = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
echo $twig->render('liste3_frudia.twig', [
    'articles_frudia' => $articles_frudia,

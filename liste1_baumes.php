...
// Requête de base pour récupérer les articles de la catégorie "Baumes"
$sql = "
...
$articles_baumes = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
echo $twig->render('liste1_baumes.twig', [
    'articles_baumes' => $articles_baumes,
    'marques' => $marques,

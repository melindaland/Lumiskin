...
// Requête de base pour récupérer les articles de la marque "Skin&Lab"
$sql = "
...
$articles_skinlab = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
echo $twig->render('liste3_skinlab.twig', [
    'articles_skinlab' => $articles_skinlab,

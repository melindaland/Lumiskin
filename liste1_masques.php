...
// Requête de base pour récupérer les articles de la catégorie "Masques"
$sql = "
...
$articles_masques = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Si aucun résultat n'est retourné, initialiser $articles_masques à un tableau vide
if (!$articles_masques) {
    $articles_masques = [];
}
...
echo $twig->render('liste1_masques.twig', [
    'articles_masques' => $articles_masques,
    'marques' => $marques,

...
// Requête de base pour récupérer les articles de la catégorie "Mains"
$sql = "
...
$articles_mains = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
echo $twig->render('liste2_mains.twig', [
    'articles_mains' => $articles_mains,
    'marques' => $marques,

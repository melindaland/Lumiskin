...
// Requête de base pour récupérer les articles de la catégorie "Visage"
$sql = "
...
$articles_visage = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
echo $twig->render('liste2_visage.twig', [
    'articles_visage' => $articles_visage,
    'marques' => $marques,

...
// Requête de base pour récupérer les articles de la catégorie "Serums"
$sql = "
...
$articles_serums = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Si aucun résultat n'est retourné, initialiser $articles_serums à un tableau vide
if (!$articles_serums) {
    $articles_serums = [];
}
...
echo $twig->render('liste1_serums.twig', [
    'articles_serums' => $articles_serums,
    'marques' => $marques,
